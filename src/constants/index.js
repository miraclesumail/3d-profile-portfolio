...
const testimonials = [
  {
    testimonial: '丰富的react开发经验和框架系统架构知识\n熟练掌握react开发技巧和生态\n使用react全家桶构建高性能网页应用',
    name: 'Sara Lee',
    designation: 'CFO',
    company: 'Acme Co',
  ...
  {
    testimonial: "熟悉掌握html5、css3、js制作web/h5页面\n精通各种网页布局，快速实现设计稿ui\n能用原生js和css实现各种复杂交互",
    name: 'Chris Brown',
    designation: 'COO',
    company: 'DEF Corp',
  ...
  {
    testimonial: "熟料掌握nodejs事件循环和io机制\n使用nestjs和MongoDB编写api后端应用\n熟悉文件流和进程管理等后端技术",
    name: 'Lisa Wang',
    designation: 'CTO',
...
const projects = [
  ...
  {
    name: 'Job IT',
    description: 'Web应用程序使用户能够搜索职位空缺、查看职位的预计薪资范围，并根据其当前位置查找可用职位',
    tags: [
      {
        name: 'react',
        color: 'blue-text-gradient',
  ...
  {
    name: 'Trip Guide',
    description: '一个全面的旅行预订平台，允许用户预订航班、酒店和租车，并提供热门目的地的精选推荐。',
    tags: [
      {
        name: 'nextjs',
        color: 'blue-text-gradient',
